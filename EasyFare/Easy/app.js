function x(){
	...
	var str = start.options[start.selectedIndex].text;
    var stop = document.getElementById("stop");
	var st = stop.options[stop.selectedIndex].text;
...
function disp(){
    ...
    for(i=0;i<ele.length;i++){
        if(ele[i].checked){
            sessionStorage.setItem('ppl',ele[i].value)
